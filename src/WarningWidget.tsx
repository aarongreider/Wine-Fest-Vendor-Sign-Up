...
export default function WarningWidget({ dirtyCount, changeLog }: Props) {
    return <>{dirtyCount > 0 || changeLog.size > 0
        ? <div className='flex row card' style={{ width: "min-content", color: 'red', fontWeight: 'bold', fontFamily: 'sans-serif', background: 'none', outline: "3px solid red", padding: "5px 10px 5px 7px" }}>
